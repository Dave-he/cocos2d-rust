        ...
        for element in &self.elements {
            match element.element_type {
                RichElementType::TEXT => {
                    ...
                    label
                        .get_node_mut()
                        .set_position(Vec2::new(current_x, current_y));
...
mod tests {
    ...
    fn test_add_text_element() {
        ...
        let element = RichElement::create_text("tag1", Color3B::WHITE, 255, "Hello", "Arial", 12.0);
    ...
    fn test_add_image_element() {
        let mut rich_text = RichText::new();
        let element =
            RichElement::create_image("img1", Color3B::WHITE, 255, "image.png", 32.0, 32.0);
        rich_text.push_back_element(element);
        assert_eq!(rich_text.elements.len(), 1);
    }
